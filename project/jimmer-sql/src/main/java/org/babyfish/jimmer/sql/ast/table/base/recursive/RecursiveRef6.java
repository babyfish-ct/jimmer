...
> extends RecursiveRef<BaseTable6<S1, S2, S3, S4, S5, S6>> {
    ...
    <T extends Table<?>> RecursiveRef7<S1, S2, S3, S4, S5, S6, T> table(Class<T> tableType);
    ...
    <T extends Date> RecursiveRef7<S1, S2, S3, S4, S5, S6, DateExpression<T>> date(Class<T> dateType);

    <T extends Temporal & Comparable<T>> RecursiveRef7<S1, S2, S3, S4, S5, S6, TemporalExpression<T>> temporal(Class<T> temporalType);
