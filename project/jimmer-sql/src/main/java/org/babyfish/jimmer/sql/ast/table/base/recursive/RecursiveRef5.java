...
> extends RecursiveRef<BaseTable5<S1, S2, S3, S4, S5>> {
    ...
    <T extends Table<?>> RecursiveRef6<S1, S2, S3, S4, S5, T> table(Class<?> tableType);
    ...
    <T extends Date> RecursiveRef6<S1, S2, S3, S4, S5, DateExpression<T>> date(Class<T> comparableType);

    <T extends Temporal & Comparable<T>> RecursiveRef6<S1, S2, S3, S4, S5, TemporalExpression<T>> temporal(Class<T> comparableType);
