...
class ColumnAccessors {
    ...
    public static Object get(Object row, int index) {
        ...
        if (row instanceof Tuple2<?, ?>) {
            ...
            switch (index) {
                case 0: return tuple.get_1();
                case 1: return tuple.get_2();
