...
> extends RecursiveRef<BaseTable8<S1, S2, S3, S4, S5, S6, S7, S8>> {
    ...
    <T extends Table<?>> RecursiveRef9<S1, S2, S3, S4, S5, S6, S7, S8, T> table(Class<T> tableType);
    ...
    <T extends Date> RecursiveRef9<S1, S2, S3, S4, S5, S6, S7, S8, DateExpression<T>> date(Class<T> dateType);

    <T extends Temporal & Comparable<T>> RecursiveRef9<S1, S2, S3, S4, S5, S6, S7, S8, TemporalExpression<T>> temporal(Class<T> temporalType);
