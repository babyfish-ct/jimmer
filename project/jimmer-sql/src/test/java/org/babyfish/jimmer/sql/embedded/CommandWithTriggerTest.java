                    ...
                    ctx.statement(it -> {
                        it.sql(
                                "select " +
                                        ...
                                        "where (tb_1_.ORDER_ITEM_A, tb_1_.ORDER_ITEM_B, tb_1_.ORDER_ITEM_C) in (" +
                                        "--->(?, ?, ?), (?, ?, ?)" +
                                        ")"
                        );
                    ...
                    ctx.statement(it -> {
                        it.sql(
                                "select " +
                                        ...
                                        "--->(tb_1_.FK_ORDER_X, tb_1_.FK_ORDER_Y) = (?, ?) " +
                                        "and " +
                                        "--->(tb_1_.ORDER_ITEM_A, tb_1_.ORDER_ITEM_B, tb_1_.ORDER_ITEM_C) not in (" +
                                        "--->(?, ?, ?), (?, ?, ?)" +
                                        ")"
                        );
                        it.variables("001", "001", 1, 1, 1, 1, 1, 3);
        ...
        executeAndExpectResult(
                ...
                ctx -> {
                    ...
                    ctx.statement(it -> {
                        ...
                        it.batchVariables(1, 1, 1, 1, "00B", "00A");
                    });
                    ctx.statement(it -> {
                        it.sql(
        ...
        executeAndExpectResult(
                ...
                ctx -> {
                    ...
                    ctx.statement(it -> {
                        ...
                        it.batchVariables(0, 1, 1, 1, "00A", "00A");
                        it.batchVariables(1, 1, 1, 1, "00B", "00A");
                        it.batchVariables(2, 1, 1, 2, "00A", "00A");
                        it.batchVariables(3, 1, 1, 2, "00A", "00B");
                    });
                    ctx.statement(it -> {
                        it.sql(
                                "delete from ORDER_ITEM " +
