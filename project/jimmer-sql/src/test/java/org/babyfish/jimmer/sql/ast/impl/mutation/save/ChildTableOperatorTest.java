...
//                (con, drafts) -> {
//                    ChildTableOperator operator = operator(getSqlClient(), con, BookStoreProps.BOOKS.unwrap());
...
//                (con, drafts) -> {
//                    ChildTableOperator operator = operator(getSqlClient(), con, OrderProps.ORDER_ITEMS.unwrap());
//                    return operator.disconnectExcept(drafts);
//                },
//                ctx -> {
//                    ctx.statement(it -> {
