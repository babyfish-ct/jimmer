        ...
        executeAndExpect(
                ...
                ctx -> {
                    ctx.sql(
                            ...
                            "tb_2_(c6, c4, c5) as (select tb_4_.GENDER, tb_4_.ID, concat(tb_4_.FIRST_NAME, ' ', tb_4_.LAST_NAME) from " +
                            "AUTHOR tb_4_ where tb_4_.ID = ?) select tb_1_.c2, tb_1_.c3, tb_2_.c4, tb_2_.c5 from tb_1_ inner join " +
                            "BOOK_AUTHOR_MAPPING tb_5_ on tb_1_.c2 = tb_5_.BOOK_ID inner join tb_2_ on tb_5_.AUTHOR_ID = tb_2_.c4 where " +
                            "tb_1_.c1 > ? and tb_2_.c6 = ?"
                    );
                }
        );
    }
        ...
        executeAndExpect(
                ...
                ctx -> {
                    ctx.sql(
                            ...
                            "all select tb_4_.PRICE, tb_4_.ID, tb_4_.NAME from BOOK tb_4_ where tb_4_.ID = ?), tb_2_(c6, c4, c5) as (select " +
                            ...
                            "where tb_6_.ID = ?) select tb_1_.c2, tb_1_.c3, tb_2_.c4, tb_2_.c5 from tb_1_ inner join BOOK_AUTHOR_MAPPING " +
                            "tb_7_ on tb_1_.c2 = tb_7_.BOOK_ID inner join tb_2_ on tb_7_.AUTHOR_ID = tb_2_.c4 where tb_1_.c1 > ? and " +
                            "tb_2_.c6 = ?"
                    );
                }
        );
