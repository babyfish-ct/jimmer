...
internal abstract class RightExpression(
    ...
    override fun renderTo(builder: AbstractSqlBuilder<*>) {
        builder.sqlClient().dialect.renderRight(
            builder,
            precedence(),
            raw as Ast,
            length as Ast
    ...
    ) : RightExpression(raw, length), KNonNullExpression<String>

    class Nullable(
        raw: KExpression<String>,
        length: KNonNullExpression<Int>
    ) : RightExpression(raw, length), KNullableExpression<String>
}