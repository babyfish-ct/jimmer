...
internal val KOTLINX_SERIALIZABLE_CLASS_NAME = ClassName("kotlinx.serialization", "Serializable")
internal val KOTLINX_TRANSIENT_CLASS_NAME = ClassName("kotlinx.serialization", "Transient")
