...
public class OneToManyTest extends AbstractMutationTest {
    ...
    public void testDetachChildByClearingForeignKey() {
        ...
        sql()
                ...
                .configure(cfg -> cfg.setDissociateAction(BookProps.STORE, DissociateAction.SET_NULL))
                .execute();
    ...
    public void testDetachChildByDeletingChild() {
        ...
        sql()
                ...
                .configure(cfg -> cfg.setDissociateAction(BookProps.STORE, DissociateAction.DELETE))
                .execute();
