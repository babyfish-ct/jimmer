...
dependencies {
	...
	implementation("org.babyfish.jimmer:jimmer-spring-boot-starter:0.6.34-0.7-preview")
	ksp("org.babyfish.jimmer:jimmer-ksp:0.6.34-0.7-preview")
