...
Due to the existence of Annotation Processor in the gradle configuration file
...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.1.4'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.1.4'
