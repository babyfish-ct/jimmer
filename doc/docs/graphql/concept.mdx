...
:::caution
In the current version, there is a limitation that when providing GraphQL services, [simple calculated properties based on SQL](../mapping/advanced/calculated/formula#based-on-sql) should NOT be used.
:::
