...
-   ❷ Use the static Input DTO type `BookInput` to allow users to pass only data structures of specified shapes to conform to (https://graphql.org/graphql-js/mutations-and-input-types/)
