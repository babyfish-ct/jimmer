...
Firstly, Jimmer does not support theoretical joins that exist but are barely used in actual projects and should be carefully avoided to prevent cartesian products.
