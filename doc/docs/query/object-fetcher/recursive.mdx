...
A common requirement is self-referencing. 

From a database perspective, self-referencing means a table's foreign key references itself. From an object model perspective, it represents a tree.

The difficulty of self-referencing is that the object depth is uncontrollable, theoretically infinite. Jimmer-sql provides great support for this.
