...
-   Spring Boot configuration:
    ...
    Declare configuration in `application.yml` or `application.properties`, named `jimmer.dialect` with value `org.babyfish.jimmer.sql.dialect.MySqlDialect`
...
-   Spring Boot configuration:
    ...
    Declare configuration in `application.yml` or `application.properties`, named `jimmer.dialect` with value `org.babyfish.jimmer.sql.dialect.PostgresDialect`
