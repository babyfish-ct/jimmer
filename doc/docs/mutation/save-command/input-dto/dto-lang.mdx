...
-   ❷ Explicitly specifies this Input DTO wants to edit the entity's many-to-one association `Book.store` using a <ViewMore buttonText="short association"><ShortAssociation/></ViewMore>. 

-   ❸ Explicitly specifies this Input DTO wants to edit the entity's many-to-many association `Book.authors` using a <ViewMore buttonText="long association"><LongAssociation/></ViewMore>.
