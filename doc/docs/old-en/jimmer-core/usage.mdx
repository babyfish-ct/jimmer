...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.8.4'
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.8.4'
}
```
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.8.4")

    // Step3: Apply ksp plugin
    ksp("org.babyfish.jimmer:jimmer-ksp:0.8.4")
}
