...
:::note
In this example, java code uses the type bootstrap method:
...
In example, kotlin code and java code are different. there is no expression `3` in kotlin code.
