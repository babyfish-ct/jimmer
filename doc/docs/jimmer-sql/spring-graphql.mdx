...
`ValueLoader` is used to quickly implement calculation property, in jimmer-sql, it means transient property with resolver, like this
...
public class BookStoreController {
    ...
    // Calculation property: BookStore.avgPrice
    // highlight-next-line
    @BatchMapping
