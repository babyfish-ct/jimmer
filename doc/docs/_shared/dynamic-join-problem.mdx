...
- When the condition is met: First join to other tables through associative attributes, then add dynamic where conditions to the joined table

- When the condition is not met: Cannot join other tables through associative attributes
