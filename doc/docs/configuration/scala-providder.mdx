...
-   ❼ If you want to define an property-level `ScalarProvider`, one option *(there are other options)* is to override the `getHandledProps` method in the derived class;
