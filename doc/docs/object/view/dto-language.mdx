...
For <ViewMore buttonText="short associations" variant="text"><ShortAssociation/></ViewMore>, of course we can choose to define [@IdView](../../mapping/advanced/view/id-view) properties in entities, for example:
