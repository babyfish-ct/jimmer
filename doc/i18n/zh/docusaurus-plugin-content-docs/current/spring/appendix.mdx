...
|jimmer.pretty-sql|boolean|false|是否格式化SQL，对执行和日志都有影响|
...
|jimmer.error-translator.http-status|HttpStatus|INTERNAL_SERVER_ERROR|服务端异常在客户端的统一HTTP状态|
...
|jimmer.client.java-feigh.indent|int|4|被自动生成的TypeScript代码的缩进量|
