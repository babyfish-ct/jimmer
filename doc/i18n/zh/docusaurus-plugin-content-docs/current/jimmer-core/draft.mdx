...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.2.15'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.2.15'
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.2.15")
    // highlight-next-line
    ksp("org.babyfish.jimmer:jimmer-ksp:0.2.15")
