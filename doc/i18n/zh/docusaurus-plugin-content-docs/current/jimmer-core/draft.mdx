...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.7.49'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.7.49'
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.7.49")
    // highlight-next-line
    ksp("org.babyfish.jimmer:jimmer-ksp:0.7.49")
