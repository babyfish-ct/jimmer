...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.6.34-0.7-preview'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.6.34-0.7-preview'
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.6.34-0.7-preview")
    // highlight-next-line
