...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.2.12'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.2.12'
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.2.12")
    // highlight-next-line
