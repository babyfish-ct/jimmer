...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.4.3'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.4.3'
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.4.3")
    // highlight-next-line
