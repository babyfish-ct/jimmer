...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.7.104'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.7.104'
...
dependencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.7.104")
    // highlight-next-line
