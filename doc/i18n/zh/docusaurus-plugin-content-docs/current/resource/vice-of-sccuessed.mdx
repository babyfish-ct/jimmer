...
<Feedback items={[
    ...
    },
    {
        ...
        content: (
            <ul>
                <li>Jimmer解决了后端DTO爆炸问题，相同功能的代码量相较于其他同类框架少很多</li>
                <li>Jimmer支持Java和kotlin双语言，在kotlin语言下使用kotlin，代码少且优雅</li>
                <li>Jimmer对于树型结构模型，非常友好，实现简单</li>
                <li>Jimmer在springboot下的repository支持Spring Data风格非常友好，极力推荐</li>
            </ul>
        )
    },
    {
