...
depdencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-sql:0.6.38-0.7-preview'
...
<dependencies>
    <dependency>
        ...
        <version>0.6.38-0.7-preview</version>
    </dependency>
    <dependency>
...
depdencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-sql-kotlin:0.6.38-0.7-preview")
