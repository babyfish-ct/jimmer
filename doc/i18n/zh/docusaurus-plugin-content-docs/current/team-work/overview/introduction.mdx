...
1.  DTO爆炸问题
    ...
    -   传统ORM方案
        ...
        :::info
        为了弥补传统ORM活性的不足，开发人员往往需要想办法做一些变通，这些努力反过来破坏ORM的初衷：便捷性。
        :::
    ...
    -   以MyBatis为代表的非ORM方案
        ...
        :::info
        这种解决方案具有绝对的灵活性和控制力，但代价是工作量大。开发能力被体现成了团队的人数规模和沟通成本。
        :::
...
3.  缓存
    ...
    -   缓存的一致性维护这个最头疼的问题应该被底层方案解决，尽可能做到全自动的，而非穿透到业务代码中由开发人员解决。
...
<ViewMore buttonText="简要了解" title="缺失动态表连接的问题" variant="outlined"><DynamicJoinProblem/></ViewMore>&nbsp;<Button href="../query/dynamic-join" size="small" variant="outlined">前往看看</Button>
